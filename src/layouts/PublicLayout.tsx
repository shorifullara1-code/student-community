      ...
      <div className={`${location.pathname.startsWith('/talika') ? 'w-full' : 'max-w-[1000px] mx-auto'} bg-white min-h-screen shadow-2xl overflow-hidden relative flex flex-col`}>
        ...
        <nav className="bg-[#2563eb] text-white flex justify-between text-sm md:text-base font-medium sticky top-0 z-10 shadow-md shrink-0">
          ...
          <div className="hidden md:flex flex-nowrap shrink-0 overflow-x-auto no-scrollbar whitespace-nowrap">
            ...
            <Link to="/talika" className={`px-3 md:px-4 py-3 flex items-center gap-1 transition shrink-0 ${isActive('/talika')}`}>
          ...
          {isMobileMenuOpen && (
            <div className="fixed inset-0 z-50 flex">
              ...
              <motion.div 
                ...
                className="relative flex flex-col w-64 max-w-sm bg-white shadow-xl h-full"
              >
